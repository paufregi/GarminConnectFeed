...
fun ActivityIcon(
    ...
    when (activityType) {
        ...
        is ActivityType.IndoorCycling -> Icon(Icons.Connect.IndoorCycling, "indoor_cycling", Modifier.size(24.dp))
        ...
        is ActivityType.OpenWaterSwimming -> Icon(Icons.Connect.OpenWaterSwimming, "open_water_swimming", Modifier.size(24.dp))
        is ActivityType.Strength -> Icon(Icons.Connect.StrengthTraining, "strength_training", Modifier.size(24.dp))
        ...
        is ActivityType.Breathwork -> Icon(Icons.Connect.Breathwork, "breathwork", Modifier.size(24.dp))
        is ActivityType.Meditation -> Icon(Icons.Connect.Meditation, "meditation", Modifier.size(24.dp))
