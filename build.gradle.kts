        ...
        resolutionStrategy.dependencySubstitution {
            listOf("4.1.93.Final", "4.1.110.Final").forEach { version ->
                substitute(module("io.netty:netty-codec-http2:$version"))
                    .using(module("io.netty:netty-codec-http2:4.1.137.Final"))
            }
            listOf("4.1.93.Final", "4.1.110.Final").forEach { version ->
                substitute(module("io.netty:netty-codec-http:$version"))
                    .using(module("io.netty:netty-codec-http:4.1.137.Final"))
            }
            listOf("4.1.93.Final", "4.1.110.Final").forEach { version ->
                substitute(module("io.netty:netty-handler-proxy:$version"))
                    .using(module("io.netty:netty-handler-proxy:4.1.137.Final"))
            }
            ...
            substitute(module("org.bouncycastle:bcprov-jdk18on:1.80.2"))
                .using(module("org.bouncycastle:bcprov-jdk18on:1.85"))
            substitute(module("org.bouncycastle:bcpkix-jdk18on:1.80.2"))
